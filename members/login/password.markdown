...
<head>
  ...
  <title>MSA Membership - Forgot password</title>
...
<form action="/msa/members/forgot-password" method="post">
  <table>
    <tr>
      <th scope="row"><label for="username">Please enter your username:</label></th>
      <td><input name="username" class="focus-first" autofocus id="username"></td>
    </tr>
    ...
    <tr>
      <td colspan="2">
        <a href="/msa/members/forgot-username" class="forgotten">Retrieve username</a>
      </td>
    </tr>
  </table>
