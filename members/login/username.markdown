...
permalink: /members/join/username/
sidebar:
  nav: login_nav
---
...
<head>
  ...
  <title>MSA Membership - Forgot username</title>
...
<form action="/msa/members/forgot-username" method="post">
  <table>
    <tr>
      <th scope="row"> Please enter your email address: </th>
      <td class="td-2"> <input name="email" autofocus value=""></td>
    </tr>
