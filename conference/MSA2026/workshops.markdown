...
following workshops during the Boston 2025 conference. You will have the
...
<details closed>
	<summary class="seminar-title" id="p1">Publishing in Modernist Journals</summary>
        ...
        <p>Modernist studies boasts a healthy publishing ecosystem, particularly in terms of its scholarly journals. We now have multiple journals devoted to all aspects of modernism, from broadly interdisciplinary journals to those focused on a specific time period, author, or form. Yet this wealth of options can make it difficult for researchers, particularly early career researchers, to differentiate among journals and find the most appropriate venues for their work. How can one identify a journal’s editorial ethos or methodological orientation, or gauge its potential receptivity to certain kinds of scholarly work? What qualities make a journal a good fit for one’s scholarship, and how can one approach that journal effectively? And, finally, how does one know when a work in progress is best developed as an article, or if it should take a different form entirely?</p>
...
<details closed>
	<summary class="seminar-title" id="p2">“What do People Do All Day (off the tenure track)?”: Organizing and Advocacy Across Contingencies</summary>
        ...
        <p>“Contingency” contains multitudes. Adjuncts; post-docs; teaching fellows; VAPs; union and non-union lecturers; professors of practice; the list goes on–there is no one title or job description that can describe teaching roles off the tenure track. With varying levels of labor protections and institutional support, disparities in job security and prestige, and differing teaching and administrative responsibilities, what unites contingent faculty across categories may simply be their shared precarity.</p>
		<p>This workshop will be facilitated by a group of scholars who have held a wide range of contingent positions–part-time and full-time, union and non-union, public and private. Together we will strive to bring greater transparency to the differences and similarities across non-tenure-track teaching roles within the university. In contingent roles, we are often siloed from other contingent workers in our own and other universities. In this way the different realities of the varied contingent positions that makeup academia prevent us from imagining the conditions that can create a “good” job. From inside one’s own role within a university one rarely sees what anyone else’s job entails, and these obscured differences can yield a failure of imagination concerning what our positions can be. Further, department leadership may not be able to imagine how to improve working conditions for their faculty when they are restrained by preconceived notions of what contingent positions can be.</p>
...
<details closed>
	<summary class="seminar-title" id="p2">"Is Anyone Going to Read This?" Publishing After the Dissertation</summary>
        ...
        <p>2-hour workshop: 1 hour panel + Q&A, 1 hour workshopping book proposal templates
		Graduate students receive guidance and supervision whilst writing their dissertations, but post-PhD life can feel disorienting without the structured mentorship of a program. Publishing is something grads and early career researchers know is incredibly significant for their careers, particularly publishing one’s dissertation in some form (whether as a monograph, other book project, or journal articles). However, turning the dissertation into a market-ready monograph (or chapters into articles) can seem an intimidating and/or opaque process. In response, this 2-hour graduate student publishing workshop aims to: help dispel some of the myths and fears around publishing the dissertation, provide information on topics like book proposals and editor relationships, and provide a space for workshopping potential proposals.</p>
		<p>The first half of the workshop will feature a roundtable discussion with participants covering a range of publishing experiences including: first steps and thinking about the book market, the academic publication process from editorial and authorial perspectives, the process of turning a dissertation into a monograph and chapters into articles, and the various ways this journey can evolve. Panelists will speak briefly in conversation with one another followed by Q&A with the audience.</p>
		<p>The second half will offer a small-group workshop, where pre-assigned groups of grads will meet with one of the panelists. The goal of this is to give feedback on and discuss draft book proposals written by 1-2 graduate students per group, which will have been pre-circulated with members of the small group beforehand. We will ask for expressions of interest for ""proposals-in-progress"" from grads close to finishing or who have recently submitted their dissertations in May/June, with proposals circulated within assigned small groups by early September. Each panelist will ‘lead’ a group of graduate students. They will discuss their group's proposal together and give feedback on its strengths and weaknesses. It is also a chance for grads to ask any outstanding questions they may have.  At the session’s conclusion, panelists will share 2-3 last points of advice and concluding remarks. The organizers (Jess and Caroline) will then close the workshop.
		</p>
...
<details closed>
	<summary class="seminar-title" id="p2">Infrastructures of Reuse: A Hands-On Workshop in Modernist (Re)Making</summary>
        ...
        <p>Inspired by modernist makers and waste-pickers like Mina Loy, Richard Bruce Nugent, H.D., Ezra Pound, and Virginia Woolf, this Modernism and Environment SIG-sponsored workshop brings together attendees to participate in a collective book arts experiment in modernist material praxis, collaboratively producing found poetry and binding pamphlets towards manifestos of sustainability in modernist scholarship and pedagogy. Seeing in the literary and artistic avant-garde of modernism a shared impulse towards remediation, reuse, and recycling, the session will invite participants to explore the reflective and embodied practices of modernism’s multimedia forms through an act of cultural re-making, recovering an ethic of sustainability at the heart of modernist aesthetics and histories, though not always expressed in directly environmental terms. We will connect modernist found, collage, and readymade poetry with contemporary practices and pedagogies also anchored in the geopolitics and aesthetics of waste and reuse, like reparative design, visible mending, or the Latin American labor/environmental justice movement of binding books from recycled cardboard (<em>cartonera</em> publishing). In adopting this transtemporal framework, our workshop emphasizes the ways modernist waste-picking and (re)making often recovered the precarious people, literatures, and environments discarded by infrastructural inequalities informed by a cultural politics of waste. </p>
		<p>Following the hands-on portion of the workshop (we have secured funding for materials which will be provided for participants), the co-facilitators will lead a discussion reflecting on how the workshop centers principles of sustainability, accessibility, collaboration, and reuse within, as a legacy of, and beyond modernist making. In particular, we will encourage participants to think about how the principles of slowness, fluidity, and plurality inherent to the models of modernist craftwork and media production (small presses, little magazines, pamphlets, etc.) offer infrastructures of reuse as an alternative to modern infrastructural models that generate both human disposability and ecological waste.
		</p>
