...
<div class="cards">
	...
	<div class="container">
		...
		<img src="/conference/MSA2026/assets/tarot_hanged.jpg" id="top2" onclick="fadeOut2()">
	</div>

	<div class="container">
		<a href="/conference/MSA2026/seminars/">
				<img src="/conference/MSA2026/assets/back_seminar.jpg.jpg" id="bottom3" style="width:0%">
		</a>
		<img src="/conference/MSA2026/assets/tarot_star.jpg" id="top3" onclick="fadeOut3()">
	</div>
	...
	<div class="container">
		...
		<img src="/conference/MSA2026/assets/tarot_moon.jpg" id="top4" onclick="fadeOut4()">
	</div>
	...
	<div class="container">
		...
		<img src="/conference/MSA2026/assets/tarot_fool.jpg" id="top5" onclick="fadeOut5()">
	</div>
	...
	<div class="container">
		...
		<img src="/conference/MSA2026/assets/tarot_world.jpg" id="top6" onclick="fadeOut6()">
	</div>
	...
	<div class="container">
		...
		<img src="/conference/MSA2026/assets/tarot_fortune.jpg" id="top7" onclick="fadeOut7()">
	</div>
	...
	<div class="container">
		...
		<img src="/conference/MSA2026/assets/tarot_priestess.jpg" id="top8" onclick="fadeOut8()">
	</div>
