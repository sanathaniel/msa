...
<p>The 2025 conference will feature keynote speakers, excursions, organized panels, seminars, roundtables, workshops, and streams of interdisciplinary panels arranged by the MSA’s Special Interest Groups (SIGs) and the local organizing committee. We look forward to welcoming participants to the <a href="https://book.passkey.com/go/ModernistStudiesAssoc2025">Sheraton in Back Bay</a>, where the conference will be within walking distance of the Museum of Fine Arts, Newbury Street, the Public Garden, and the Historic North End.</p> 
