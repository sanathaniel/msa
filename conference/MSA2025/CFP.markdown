...
<p>The 2025 conference will feature keynote speakers, excursions, organized panels, seminars, roundtables, workshops, and streams of interdisciplinary panels arranged by the MSA’s Special Interest Groups (SIGs) and the local organizing committee. We look forward to welcoming participants to the <a href="https://www.marriott.com/en-us/hotels/bosbo-sheraton-boston-hotel/overview/">Sheraton in Back Bay</a>, where the conference will be within walking distance from the Museum of Fine Arts, Newbury Street, the Public Garden, and the Historic North End.</p> 
...
<p>The Modernism and Pedagogy SIG seeks papers that reflect modernist scholar-teachers coping with the infrastructure (or lack thereof) in the universities we teach in. </p>
 
<p>We'd like to hear about adapting pedagogy to classrooms or other spaces that are unconventional due to deferred maintenance; "doing more with less" teaching methods (potentially in terms of library resources being cut, department budgets for photocopies ending, etc.); curriculum innovations that underscore the need to widen one's teaching specialties; etc. </p>
 
<p>We are also hoping for success stories: unexpected adaptations in infrastructure — for example, assignments; peer observations or connections; organizing — that have led to a positive difference; a replacement in infrastructure; or, if possible...subversions, workarounds, solidarities. </p>
 
<p>And, as ever, we invite papers that address more general pedagogical concerns: teaching modernist texts across course types (literature surveys; first-year writing; basic writing; the modernist novel; etc.); modernist studies’ connections to other disciplines in the classroom, such as creative writing, composition studies, or women's & gender studies; (modernist) pedagogy and/as (modernist) scholarship—how do we articulate this relationship? Lastly, we hope papers will address the lived conditions of our teaching labor, with institutional pressures and constraints both demanding creativity in our pedagogy as it potentially creates limits.</p>
