...
<div id="main-banner">
  ...
  style="background-color: #000; background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(assets/nevinson_dance_hall.jpg);">
    <div class="wrapper">
	...
	<div class="feature__wrapper">
		...
		<div class ="feature__item" style="border:20px;">
			<div class="feature__item-teaser">
				...
				<figcaption  class="archive__item-title">Registration for Modernist Crossings: now open!</figcaption>
		...
		<div class ="feature__item" style="border:20px;">
			<div class="feature__item-teaser">
				...
				<h3>MSA 2027</h3>
				<figcaption  class="archive__item-title">Announcing MSA'27, to be held in Tallahassee.</figcaption>
		...
		<div class ="feature__item">
				...
				<h3>Membership</h3>
				<figcaption  class="archive__item-title">Join the Modernist Studies Association.</figcaption>
