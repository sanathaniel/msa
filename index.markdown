...
<div id="main-banner">
  ...
  style="background-color: #000; background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(assets/vorticism1.jpg);">
    <div class="wrapper">
...
<div class="main-wrapper">
	<div class="feature__wrapper">
		<div class ="feature__item" style="border:20px;">
			...
			<a href="https://msa.press.jhu.edu/conferences/msa2024/" class="btn btn--primary">Gather</a>
		</div>
